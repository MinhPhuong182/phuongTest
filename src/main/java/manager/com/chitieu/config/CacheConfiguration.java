package manager.com.chitieu.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("quanlychitieu");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("quanlychitieu");
        ...
        config.getMapConfigs().put("manager.com.chitieu.domain.*", initializeDomainMapConfig(jHipsterProperties));
